...
VALUES
  ('Calcio King''s League', 'single', 0, TRUE),
  ('Padel', 'pair', 0, TRUE),
  ('Tennis', 'single', 0, TRUE),
  ('Ping Pong', 'single', 0, TRUE),
  ('Tiro con l''Arco', 'single', 0, TRUE),
  ('Burraco', 'pair', 0, TRUE),
  ('Scacchi', 'single', 0, TRUE),
  ('Scopa', 'pair', 0, TRUE),
  ('Lupopoli', 'single', 0, TRUE),
  ('Volley', 'single', 0, TRUE),
  ('Biliardino', 'pair', 0, TRUE),
  ('Calcio 1 vs 1', 'single', 0, TRUE)
